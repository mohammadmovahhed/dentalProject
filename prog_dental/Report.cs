...
namespace prog_dental
{
    public partial class Report : UserControl
    {
        ...
        private void نمایشاطاعاتToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewX2.Columns["Id"].Visible = false;
            dataGridViewX2.Columns["Doctor_Id"].Visible = false;
            dataGridViewX2.Columns["User_Id"].Visible = false;
            dataGridViewX2.Columns["User"].Visible = false;
            dataGridViewX2.Columns["Doctor"].Visible = false;
        }
